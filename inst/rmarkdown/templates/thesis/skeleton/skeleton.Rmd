...
#  oakdown::thesis_gitbook: default         
#  oakdown::thesis_word: default
#  oakdown::thesis_epub: default

# If you are creating a PDF you'll need to write your preliminary content 
# (e.g., abstract, acknowledgments) below or use code similar to line 25-26 
# for the .RMD files. If you are NOT producing a PDF, delete or silence
# lines 25-39 in this YAML header.
include-pdflot: false
include-pdflof: true
include-pdftoc: false
include-pdfabstract: false
include-pdfacknowledgments: false
include-pdfdedication: false
include-pdfpreface: false
pdfabstract: |
...
pdfdedication: |
  '`r if(knitr:::is_latex_output()) paste(readLines(here::here("prelims", "00-dedication.Rmd")), collapse = "\n  ")`'
pdfpreface: |
  '`r if(knitr:::is_latex_output()) paste(readLines(here::here("prelims", "00-preface.Rmd")), collapse = "\n  ")`'
...
`r if(!knitr:::is_latex_output()) '# Acknowledgments {-}'`
```{r eval=!knitr::is_latex_output(), child=here::here("prelims", "00-acknowledgments.Rmd")}

```

`r if(!knitr:::is_latex_output()) '# Dedication {-}'`
```{r eval=!knitr::is_latex_output(), child=here::here("prelims", "00-dedication.Rmd")}

```

`r if(!knitr:::is_latex_output()) '# Preface {-}'`
```{r eval=!knitr::is_latex_output(), child=here::here("prelims", "00-preface.Rmd")}
